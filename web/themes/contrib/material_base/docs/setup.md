...
Material Base is a "base" theme which means it's not intended for direct usage. In most cases, you will need to create a "subtheme" and specify Material Base as a "base" theme.
...
For detailed information about how to create a subtheme from the template, see [Subtheme template](subtheme-template.md).
