...
Material Base provides well-selected default breakpoints with naming in Bootstrap 3 flavor:
...
Breakpoint values of these files are prefilled with default MB breakpoints values and should be updated manually if needed.
