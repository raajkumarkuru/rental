...
In theory, it could be replaced by other libraries, custom implementations, new versions of the MDC library, or something else. Material Base 2 was developed in mind with using of this subtheme is a common case, but using without it is also possible.
