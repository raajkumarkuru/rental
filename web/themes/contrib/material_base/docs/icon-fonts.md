...
All these fonts are hosted on Google Fonts servers.

Using icons
-----------

Icons could be displayed with a ligature font feature:
...
Icon font supports sizing and coloring by CSS the same way as regular fonts do.

For Two Tone icons coloring could be achieved differently:
