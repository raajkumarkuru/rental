...
Material Base provides Sass variables for the site level customizations and options.

Defined variables and their default values stored in `sass\base\variables.scss`.

Main colors and typography variables reflect the [MDC library](mdc.md) variables structure.
