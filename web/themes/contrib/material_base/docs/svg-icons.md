...
Icons could be displayed with the "use" tag SVG feature:
...
* `FILE_NAME` is the name of an SVG file with the desired icon which was previously paced in `icons` folder.
