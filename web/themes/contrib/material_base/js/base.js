    ...
    attach: (context, settings) => {
      ...
      const handleAccordionToggle = (toggle, e) => {
        ...
        const otherSections = Array.from(
          toggle.closest('.mb-accordion').querySelectorAll('.mb-accordion__section'),
      ...
      const handleDropdown = (element, e) => {
        ...
        if (currentDropdown.closest('.mb-dropdown__group')) {
          otherDropdowns = Array.from(
            currentDropdown.closest('.mb-dropdown__group').querySelectorAll('.mb-dropdown'),
      ...
      once('materialBaseFunctions', 'html').forEach(() => {
        ...
        document.body.addEventListener('keyup', e => {
          if (e.key === 'Escape') {
            removeBodyClass('overlay-open');
            removeBodyClass('drawer-open');
            removeBodyClass('search-open');
            removeBodyClass('search-autocomplete-open');
            closeAllDropdowns();
          }
        });
      ...
      // Status messages close the button.
